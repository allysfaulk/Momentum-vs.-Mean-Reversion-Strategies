...
Preliminary results suggest:
  Momentum strategies tend to perform better in trending markets and growth stocks
  Mean-reversion strategies perform better in range-bound or defensive assets
  Strategy effectiveness depends heavily on both asset type and market regime
